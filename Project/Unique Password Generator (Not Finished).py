...
#my_password += chr(randint(34,126)) - All characters, numbers and symbols
    ...
    my_button.grid(row=0, column=0, padx=10)
    save_password = Button(my_frame, text="Save Password", command=save_password)
    save_password.grid(row=0, column=1, padx=10)
    saved_password = Button(my_frame, text="Look at Saved Passwords!")
    saved_password.grid(row=0, column=2,  padx=10, pady=10)
